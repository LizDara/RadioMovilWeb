...
<link id="theme-stylesheet" rel="stylesheet" href="./css/nuevo-servicio.css">
<script src="./js/nuevo-servicio.js"></script>
...
<aside class="mdc-drawer">
    ...
    <div class="mdc-drawer__content">
        <nav class="mdc-list">
            ...
            <a id="item-selected" class="mdc-list-item" href="./servicio-admin">
                <span class="mdc-list-item__ripple"></span>
                <i id="item-icon-selected" class="material-icons mdc-list-item__graphic" aria-hidden="true">commute</i>
    ...
    <div class="mdc-drawer__content" style="display: contents">
        ...
        <nav id="final-buttons" class="mdc-list">
            <button id="edit-profile-button" class="mdc-button mdc-button--outlined edit-profile-button">
                <span class="mdc-button__ripple"></span>
                <span class="mdc-button__label">Modificar perfil</span>
            </button>
            <button id="logout-button" class="mdc-button mdc-button--outlined logout-button">
                <span class="mdc-button__ripple"></span>
    ...
    <div class="row align-items-center min-vh-100">
        <div id="login-form" class="col" style="justify-content: center">
            <div style="max-width: 400px; margin: auto;">
                <h1 style="font-size: 4rem; font-weight: 700; margin: 24px;">Nuevo servicio</h1>
                ...
                <label class="mdc-text-field mdc-text-field--outlined descripcion">
                  <span class="mdc-notched-outline">
                    <span class="mdc-notched-outline__leading"></span>
                    <span class="mdc-notched-outline__notch">
                      <span class="mdc-floating-label">Descripción</span>
                    </span>
                    <span class="mdc-notched-outline__trailing"></span>
                  </span>
                    <input id="descripcion" type="text" class="mdc-text-field__input" aria-labelledby="descripcion">
                </label>
                <span id="descripcion-error" class="helper-text" style="color: #F44336; text-align: left"></span>
                ...
                <button id="add-servicio-button" class="add-servicio-button mdc-button mdc-button--raised">
                    <span class="add-servicio-button-text mdc-button__label">Añadir servicio</span>
                </button>
            </div>
        </div>
        <div id="second-content" class="col-md" style="justify-content: center; align-items: center; height: 100vh; overflow: auto">
            <h1 style="font-size: 4rem; font-weight: 700; margin: 24px;">Servicios registrados</h1>
            {{--Card--}}
            @foreach($data['servicio'] as $servicio)
                <div class="mdc-card" style="margin: 24px">
                    ...
                    <div class="mdc-card__actions">
                        <button class="edit-card-button mdc-button mdc-card__action mdc-card__action--button" onclick="openEditDialog({{ json_encode($servicio) }})">
                            <div class="mdc-button__ripple"></div>
                            <span class="mdc-button__label">Editar</span>
                        </button>
                        <button class="remove-card-button mdc-button mdc-card__action mdc-card__action--button" onclick="openDeleteDialog('{{ $servicio->id }}')">
                            <div class="mdc-button__ripple"></div>
...
<div class="mdc-dialog edit-dialog">
    <div class="mdc-dialog__container">
        <div class="mdc-dialog__surface"
            ...
            <h2 class="mdc-dialog__title" id="my-dialog-title">Editar servicio</h2>
                ...
                <div id="login-form" class="col" style="justify-content: center">
                  ...
                  <span class="mdc-notched-outline">
                    ...
                    <span class="mdc-notched-outline__trailing"></span>
                        ...
                        <label class="mdc-text-field mdc-text-field--outlined descripcion-edit">
                  <span class="mdc-notched-outline">
                    <span class="mdc-notched-outline__leading"></span>
                    <span class="mdc-notched-outline__notch">
                      <span class="mdc-floating-label">Descripción</span>
                    ...
                    <span class="mdc-notched-outline__trailing"></span>
                            ...
                            <input id="descripcion-edit" type="text" class="mdc-text-field__input" aria-labelledby="descripcion">
                        </label>
                        <span id="descripcion-error-edit" class="helper-text" style="color: #F44336; text-align: left"></span>
