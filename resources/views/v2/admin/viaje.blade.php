...
<aside class="mdc-drawer" style="height: auto">
    ...
    <div class="mdc-drawer__content">
        <nav class="mdc-list">
            ...
            <a id="item-selected" class="mdc-list-item" href="./viaje-admin">
                <span class="mdc-list-item__ripple"></span>
                <i id="item-icon-selected" class="material-icons mdc-list-item__graphic" aria-hidden="true">map</i>
                <span id="item-text-selected" class="mdc-list-item__text">Viajes</span>
            </a>
        </nav>
    </div>
...
<div class="container-fluid mh-100 min-vh-100" >
    <div class="row align-items-center min-vh-100">
        <div id="login-form" class="col" style="justify-content: center; height: 100vh; overflow: auto">
            <div style="max-width: 600px; margin: auto;">
                <h1 style="font-size: 4rem; font-weight: 700; margin: 24px;">Viajes</h1>
                {{--Card--}}
                @foreach($data['viaje'] as $viaje)
                    <div class="mdc-card" style="margin: 24px">
                        ...
                        <div class="color-text" style="font-size: 1.25rem; line-height: 2rem; font-weight: 700; margin: 0px 16px 24px 16px">
        ...
        <div id="second-content" class="col-md" style="justify-content: center; align-items: center; height: 100vh; overflow: auto">
            <img src="./assets/menu-admin.png" alt="Welcome" class="img-fluid" style="padding: 64px; margin-top: 128px">
        </div>
    </div>
</div>
</body>
