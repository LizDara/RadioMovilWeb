...
<script src="./js/chofer/promocion.js"></script>
...
<aside class="mdc-drawer" style="height: auto">
    ...
    <div class="mdc-drawer__content">
        <nav class="mdc-list">
            ...
            <a id="item-selected" class="mdc-list-item" href="./promocion-chofer">
                <span class="mdc-list-item__ripple"></span>
...
<div class="container-fluid mh-100 min-vh-100" >
    <div class="row align-items-center min-vh-100">
        <div id="login-form" class="col" style="justify-content: center; max-height: 100vh; overflow: auto">
            ...
            @if(count($data['promocion']) === 0)
                <h2 style="margin-left: 24px">No existen promociones registradas.</h2>
            @else
                @foreach($data['promocion'] as $promocion)
                    <div class="mdc-card" style="margin: 24px">
                        ...
                        <div class="parada-text" style="margin-left: 16px; margin-right: 16px; font-size: .875rem; line-height: 1.25rem; font-weight: 400; opacity: .6;">
                            Del {{ substr($promocion->fechainicio, 8, 2) }}/{{ substr($promocion->fechainicio, 5, 2) }}/{{ substr($promocion->fechainicio, 0, 4) }} al {{ substr($promocion->fechafin, 8, 2) }}/{{ substr($promocion->fechafin, 5, 2) }}/{{ substr($promocion->fechafin, 0, 4) }}
                        </div>
        ...
        <div id="second-content" class="col-md" style="display: flex; justify-content: center; flex-direction: column; height: 100vh">
            <img src="./assets/promocion.png" alt="Welcome" class="img-fluid" style="padding: 64px">
        </div>
    </div>
</div>
</body>
