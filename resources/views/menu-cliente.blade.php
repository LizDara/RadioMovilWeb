...
<div class="container-fluid mh-100 min-vh-100" >
    <div class="row align-items-center min-vh-100">
        <div id="login-form" class="col" style="justify-content: center">
            <h1 style="font-size: 4rem; font-weight: 700; margin-bottom: 24px;">Servicios disponibles</h1>
            {{--Card--}}
            <div class="mdc-card mdc-card--outlined">
                <div class="card-title" style="font-size: 1.25rem; line-height: 2rem; font-weight: 500; margin: 16px 16px 8px 16px">
                    Traslado
                </div>
                <div class="card-content mdc-card__content" style="margin-left: 16px; font-size: .875rem; line-height: 1.25rem; font-weight: 400; opacity: .6;">
                    Nuestros móviles están disponibles para trasladarlo a usted por distintos lugares dentro de Santa Cruz.
                </div>
                <div class="mdc-card__actions">
                    <button class="more-info-button mdc-button mdc-card__action mdc-card__action--button">
