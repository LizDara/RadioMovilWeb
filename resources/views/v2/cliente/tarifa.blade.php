...
<link id="theme-stylesheet" rel="stylesheet" href="./css/cliente/tarifa.css">
<script src="./js/cliente/tarifa.js"></script>
        ...
        <div id="login-form" class="col" style="justify-content: center; max-height: 100vh; overflow: auto">
            ...
            <div class="mdc-card" style="margin: 24px">
                ...
                <div class="color-text" style="font-size: 1.25rem; line-height: 2rem; font-weight: 500; margin: 0px 16px 32px 16px">
                    Cada 1 kilómetro(s) tiene un costo de 4Bs.
                </div>
                <div class="color-text" style="font-size: 1.25rem; line-height: 2rem; font-weight: 500; margin: 0px 16px 32px 16px">
                    Cada 3 kilómetro(s) tiene un costo de 7Bs.
                </div>
                <div class="color-text" style="font-size: 1.25rem; line-height: 2rem; font-weight: 500; margin: 0px 16px 32px 16px">
                    Cada 5 kilómetro(s) tiene un costo de 12Bs.
                </div>
                <div class="color-text" style="font-size: 1.25rem; line-height: 2rem; font-weight: 500; margin: 0px 16px 32px 16px">
                    Cada 7 kilómetro(s) tiene un costo de 20Bs.
                </div>
            </div>
        </div>
