...
<link id="theme-stylesheet" rel="stylesheet" href="./css/registro.css">
    ...
    <div class="row align-items-center min-vh-100">
        <div id="login-form" class="col" style="overflow: auto; height: 100vh">
            ...
            <div style="max-width: 400px; margin: auto;">
                <h1 style="font-size: 3.5rem; font-weight: 700; margin: 24px;">Registro</h1>
                <label class="mdc-text-field mdc-text-field--outlined dni">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="dni" type="text" class="mdc-text-field__input" aria-labelledby="dni">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined first-name">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="first-name" type="text" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined last-name">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="last-name" type="text" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined birthdate">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="birthdate" type="date" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined phone">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="phone" type="text" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined address">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="address" type="text" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <label class="mdc-text-field mdc-text-field--outlined password">
                  <span class="mdc-notched-outline">
                    ...
                    <input id="password" type="password" class="mdc-text-field__input" aria-labelledby="email">
                </label>
                ...
                <h6>¿Ya tienes una cuenta? <a href="./">Inicia sesión.</a></h6>
            </div>
        </div>
